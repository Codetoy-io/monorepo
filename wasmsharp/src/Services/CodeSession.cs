...
internal sealed class CodeSession
{
    ...
    public async Task<RunResult> RunAsync()
    {
        ...
        if (result.Success)
        {
            ...
            System.Console.WriteLine($"assembly: {assembly.FullName}");
            System.Console.WriteLine($"assembly entry point: {assembly.EntryPoint}");
            using var captureOutput = new StringWriter();
            var oldOut = System.Console.Out;
            System.Console.SetOut(captureOutput);
...
#pragma warning disable CA1031 // Do not catch general exception types
            ...
            catch (Exception ex)
            {
                var s = ex.ToString();
                errorOut = s;
                await System.Console.Error.WriteLineAsync(s).ConfigureAwait(false);
            }
            finally
            {
...
#pragma warning restore CA1031 // Do not catch general exception types
            ...
            System.Console.WriteLine("Captured output: ");
            System.Console.WriteLine(capturedOutput);
